...
export default function ProjectWorkspace() {
  ...
  return <div style={{ flex: 1, minWidth: 0, minHeight: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
    <nav style={{ flexShrink: 0, padding: '14px 28px', borderBottom: '1px solid #eee', display: 'flex', gap: 8 }}>
